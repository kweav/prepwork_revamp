...
Once you have done this, verify that you are in this directory using the `pwd` command. In this case, "shared" is the **parent** directory of "data".
